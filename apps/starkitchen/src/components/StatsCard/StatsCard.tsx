        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              <p className="text-sm font-medium text-muted-foreground">Total Meal Count</p>
            ...
            <div className="space-y-2">
              <p className="text-sm font-medium text-muted-foreground">Foodie Rank</p>
              <div className="flex items-center space-x-2">
          ...
          <div>
            <p className="text-sm font-medium text-muted-foreground mb-2">Meals by Day of Week</p>
            <div className="h-64">
            {allTimeMealCount ? (
              <ChartContainer
                config={{
